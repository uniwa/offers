...
<div class="well span8">
    ...
    <ol>
        ...
        <li><p>Επικολλήστε τις διευθύνσεις στο πεδίο «BCC» (Ιδιαίτερη κοινοποίηση) του προγράμματος αποστολής e-mail που χρησιμοποιείτε (πχ, Mozilla Thunderbird®, Microsoft Outlook®).</p></li>
    </ol>
