<div class="modal fade" id="termsModal">
  ...
  <div class="modal-body">
    <p><strong>ΠΑΡΑΚΑΛΟΥΜΕ ΔΙΑΒΑΣΤΕ ΤΟΥΣ ΠΑΡΑΚΑΤΩ ΟΡΟΥΣ ΧΡΗΣΗΣ ΠΡΟΣΕΚΤΙΚΑ ΚΑΘΩΣ ΠΕΡΙΕΧΟΥΝ ΤΟΥΣ ΟΡΟΥΣ ΚΑΙ ΠΡΟΫΠΟΘΕΣΕΙΣ ΠΟΥ ΕΦΑΡΜΟΖΟΝΤΑΙ ΣΤΗΝ ΑΠΟ ΜΕΡΟΥΣ ΣΑΣ ΧΡΗΣΗ ΤΩΝ ΥΠΗΡΕΣΙΩΝ ΜΑΣ ΚΑΙ ΤΗΝ ΑΚΟΛΟΥΘΟΥΜΕΝΗ ΠΟΛΙΤΙΚΗ ΠΡΟΣΤΑΣΙΑΣ ΠΡΟΣΩΠΙΚΩΝ ΔΕΔΟΜΕΝΩΝ ΚΑΙ ΟΙ ΟΠΟΙΟΙ ΣΥΝΙΣΤΟΥΝ ΝΟΜΙΚΑ ΔΕΣΜΕΥΤΙΚΗ ΣΥΜΦΩΝΙΑ ΜΕΤΑΞΥ ΣΑΣ ΚΑΙ ΤΗΣ ΕΤΑΙΡΙΑΣ ΜΑΣ</strong>
<hr>
...
<ul>
<li>Α) Όταν ο επισκέπτης χρήστης εγγράφεται στις υπηρεσίες του</li>
<li>Β) Όταν χρησιμοποιεί τις υπηρεσίες του</li>
<li>Γ) Όταν χρησιμοποιεί τις σελίδες του site και εισέρχεται στα προγράμματα</li>
</ul>
<hr>
...
<br>
<ul>
<li>Α) την εκπλήρωση των όρων και υποχρεώσεων των επιμέρους υπηρεσιών, που παρέχει το site στους χρήστες του,</li>
<li>Β) την εν γένει ενημέρωση του χρήστη,</li>
<li>Γ) την ικανοποίηση των εκάστοτε απαιτήσεων του χρήστη αναφορικά με τις υπηρεσίες που διατίθενται από και μέσω του site,</li>
<li>Δ) την ενημέρωση του χρήστη σχετικά με νέες υπηρεσίες,</li>
<li>Ε) την εύρυθμη λειτουργία του site,</li>
<li>Τ) κάθε συναφή με τα ανωτέρω ενέργεια</li>
</ul>
</p>
  </div>
  <div class="modal-footer">
    <?php echo $this->Html->link(__('Μετάβαση στη σελίδα'), array( 'controller'=>'users', 'action'=>'register'), array( 'class' => 'btn btn-inverse'));?>
  </div>
</div>
